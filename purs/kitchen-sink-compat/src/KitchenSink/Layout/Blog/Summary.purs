...
module KitchenSink.Layout.Blog.Summary where
...
--------------------------------------------------------------------------------
newtype GlossaryItem =
    GlossaryItem {
      term :: String
    , definition :: String
    }

instance encodeJsonGlossaryItem :: EncodeJson GlossaryItem where
  encodeJson = genericEncodeAeson Argonaut.defaultOptions
instance decodeJsonGlossaryItem :: DecodeJson GlossaryItem where
  decodeJson = genericDecodeAeson Argonaut.defaultOptions
derive instance genericGlossaryItem :: Generic GlossaryItem _
derive instance newtypeGlossaryItem :: Newtype GlossaryItem _

--------------------------------------------------------------------------------
_GlossaryItem :: Iso' GlossaryItem { term :: String, definition :: String}
_GlossaryItem = _Newtype

--------------------------------------------------------------------------------
newtype GlossarySummary =
    GlossarySummary {
      glossary :: Array GlossaryItem
    }

instance encodeJsonGlossarySummary :: EncodeJson GlossarySummary where
  encodeJson = genericEncodeAeson Argonaut.defaultOptions
instance decodeJsonGlossarySummary :: DecodeJson GlossarySummary where
  decodeJson = genericDecodeAeson Argonaut.defaultOptions
derive instance genericGlossarySummary :: Generic GlossarySummary _
derive instance newtypeGlossarySummary :: Newtype GlossarySummary _
...
_DocumentTarget :: Prism' TargetType Unit
_DocumentTarget = prism' (\_ -> DocumentTarget) f
  where
    f DocumentTarget = Just unit
    f _ = Nothing
...
_GlossaryTarget :: Prism' TargetType Unit
