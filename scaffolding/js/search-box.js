...
(() => {
  ...
  var getBasePath = function(elemId) {
    return function __do2() {
      var win = windowImpl();
      var doc = document(win)();
      var mEl = getElementById(elemId)(toNonElementParentNode(toDocument(doc)))();
      if (mEl instanceof Nothing) {
        return "";
      }
      ;
      if (mEl instanceof Just) {
        return map29(fromMaybe(""))(getAttribute("data-base-path")(mEl.value0))();
      }
      ;
      throw new Error("Failed pattern match at KitchenSink (line 44, column 3 - line 46, column 69): " + [mEl.constructor.name]);
    };
  };
  var fetchPaths = function(baseUrl) {
    return bind15(get3(json)(baseUrl + sitePaths))(function(resp) {
      return pure14(map111(function(x) {
    ...
    return function(props) {
      ...
      var renderRoutes = function(state3) {
        return function(visibility) {
          return function(rts) {
            ...
            return div2([classes(["routes-list", visibilityClass(visibility)])])([div_([renderCollapseListButton]), ul([class_("routes-list-list")])(map30(function(x) {
      ...
      var handleAction = function(v) {
        ...
        if (v instanceof ToggleItemVisibility) {
          return bind9(get5)(function(st0) {
            return discard6(put3((function() {
              ...
              return when4(notEq2(st0.expanded)(new Just(v.value1)) && v.value0)(liftEffect8(preventDefault(toEvent(v.value2))));
            });
          });
        }
        ;
  ...
  var showTargetType = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Main (line 153, column 18 - line 171, column 35): " + [v.constructor.name]);
  };
  var renderTopicImage = function(url2) {
    return img([src9(url2)]);
  };
  var renderTopicHashtags = function(tags) {
    var ht = function(t) {
      return li([class_("hashtags-list-item")])([text5("#" + t)]);
    };
    return ul([class_("hashtags-list")])(map31(ht)(tags));
  };
  ...
  var renderFavicon = function(url2) {
    return img([src9(url2), width8(32), height8(32)]);
  };
  ...
  var renderRoute = function(visibility) {
    return function(v) {
      var visibilityClass = (function() {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 79, column 23 - line 81, column 46): " + [visibility.constructor.name]);
      })();
      var topicImage = preview((function() {
        ...
        return function($70) {
          return _TargetSummary2($68(_Just2(_TopicSummary2($69(_Just2($70))))));
        };
      })())(v.value1);
      ...
      var preambleFavicon = preview((function() {
        ...
        return function($79) {
          return _TargetSummary2($77(_Just2(_PreambleSummary2($78($79)))));
        };
      })())(v.value1);
      var hashtags = toArrayOf((function() {
        ...
        return function($83) {
          return _TargetSummary2($80(_HashTagSummary2($81(traversed2(_HashTagItem2($82($83)))))));
        };
      })())(v.value1);
  ...
  var matchRoute = function(filter3) {
    return function(v) {
      var hashtags = toArrayOf((function() {
        ...
        var $86 = to2(function(v1) {
          return v1.hashtag;
        });
        return function($87) {
          return _TargetSummary2($84(_HashTagSummary2($85(traversed2(_HashTagItem2($86($87)))))));
        };
      })())(v.value1);
      var f = matchFilter(filter3);
      var inHashtags = or2(map31(f)(map31(function(v1) {
        return "#" + v1;
      })(hashtags)));
      ...
      var inTitle = preview((function() {
        var $91 = to2(function(v1) {
          return v1.textualTitle;
        });
        var $92 = to2(f);
        return function($93) {
          return _TargetSummary2($91(_Just2($92($93))));
        };
      })())(v.value1);
      return or2([f(v.value0), fromMaybe(false)(inTitle), fromMaybe(false)(inSummary), inHashtags]);
    };
  };
  var fetchPathList = function(basePath) {
    return bind10(fetchPaths(basePath))(function(res) {
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind10(awaitBody)(function(body2) {
    return bind10(liftEffect7(getBasePath("search-box")))(function(basePath) {
      return bind10(liftAff2(fetchPathList(basePath)))(function(blogPaths) {
        var routes = toArrayOf((function() {
          var $94 = to2(function(v) {
            return v.paths;
          });
          return function($95) {
            return _Just1(_PathList2($94(traversed2($95))));
          };
        })())(blogPaths);
        return bind10(selectElement("#search-box"))(function(elem3) {
